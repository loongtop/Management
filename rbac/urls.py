...
urlpatterns = [
    ...
    re_path(r'^user/create/$', user.user_create, name='user_create'),
    re_path(r'^user/update/(?P<pk>\d+)/$', user.user_update, name='user_edit'),
    re_path(r'^user/del/(?P<pk>\d+)/$', user.user_delete, name='user_del'),
